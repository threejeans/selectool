...
const SelfCard = ({ data }: CardProps) => {
  ...
  return (
    <Link to={`/self/${data.individualToolNameEn.toLowerCase()}`}>
      <div
      ...
      >
        ...
        <div className={styles.contentsContainer}>
          ...
          <div className={styles.textContainer}>
            ...
            <div className={styles.description}>{data.individualToolInfo}</div>
          </div>
        </div>
      </div>
    </Link>
