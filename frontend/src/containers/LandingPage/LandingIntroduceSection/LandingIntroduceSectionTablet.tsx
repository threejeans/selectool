...
const LandingIntroduceSectionTablet = () => {
  return (
    <div id='section02' className={styles.containerTablet}>
      <div className={styles.contentsTablet}>
        ...
        <div className={styles.bubbbleSection}>
          <div
            className={`${styles.bubble_containerTablet} ${styles.bubble_01Tablet}`}
            data-aos='fade-up'
          >
          ...
          <div
            className={`${styles.bubble_containerTablet} ${styles.bubble_02Tablet}`}
            data-aos='fade-up'
          >
          ...
          <div
            className={`${styles.bubble_containerTablet} ${styles.bubble_03Tablet}`}
            data-aos='fade-up'
          >
            <img className={styles.bubble_em_left} src={emLeft} alt={''} />
...
export default LandingIntroduceSectionTablet
