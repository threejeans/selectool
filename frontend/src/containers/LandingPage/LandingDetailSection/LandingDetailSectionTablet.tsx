...
const LandingDetailSectionTablet = () => {
  return (
    <div className={styles.container_Tablet}>
      <div className={styles.contents}>
        ...
        <div className={styles.main_contents_Tablet}>
          ...
          <div className={styles.image_section_Tablet}>
            <div className={styles.image_container_Tablet}>
              <img
                src={image01Back}
                className={styles.image_back_01_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
              <img
                src={image01Front}
                className={styles.image_front_01_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
            </div>
        ...
        <div className={`${styles.main_contents_Tablet} ${styles.right} `}>
          <div data-aos='fade-right'>
            <h4 className={styles.detail_title}>
              <span className={styles.highlight}>[&emsp;&emsp;]</span>은 이러한
              협업툴을 사용하고 있어요
            </h4>
            <hr className={styles.line_right_Tablet} />
            <div className={commonStyles.description}>
          ...
          <div className={styles.image_section_Tablet}>
            <div className={styles.image_container_Tablet}>
              <img
                src={image02Back}
                className={styles.image_back_02_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
              <img
                src={image02Front}
                className={styles.image_front_02_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
            </div>
        ...
        <div className={styles.main_contents_Tablet}>
          ...
          <div className={styles.image_section_Tablet}>
            <div className={styles.image_container_Tablet}>
              <img
                src={image03Back}
                className={styles.image_back_03_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
              <img
                src={image03Front}
                className={styles.image_front_03_Tablet}
                alt=''
                data-aos='fade-up-left'
              />
            </div>
...
export default LandingDetailSectionTablet
